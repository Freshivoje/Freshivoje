    ...
    class OutStoragePDF
    {
        ...
        public void exportgridview(DataGridView dgw)
        {
            ...
            try
            {
                ...
                PdfPTable palleteNumber = new PdfPTable(1);
                ...
                palleteNumber.WidthPercentage = 80;
                palleteNumber.DefaultCell.BorderWidth = 0;
                ...
                palleteNumber.AddCell(new Phrase("BROJ PALETE - " + _pallete_number, font));
