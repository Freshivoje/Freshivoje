...
namespace Freshivoje.Custom_Classes
{
    public class CreatePDF
    {
        ...
        {
            Paragraph footer = new Paragraph("________________                                                                          ________________", _font);
            footer.Font.Size = 12;
        ...
        {
            Paragraph footer2 = new Paragraph("Potpis klijenta:                                                                                 Potpis izdavaoca:", _font);
        ...
        public void exportgridview(DataGridView dgw)
        {
            ...
            try
            {
                ...
                Chunk c1 = new Chunk("REŠIVOJE", _font);
                ...
                Chunk c3 = new Chunk("Aleksandar Đorđević", _font);
                ...
                Chunk c4 = new Chunk("PIB: 1118657152", _font);
                c3.Font.Color = new BaseColor(0, 0, 0);
                c3.Font.SetStyle(0);
                c3.Font.Size = 11;
                ...
                Chunk c5 = new Chunk("Matični broj: 65511037", _font);
                c3.Font.Color = new BaseColor(0, 0, 0);
                c3.Font.SetStyle(0);
                c3.Font.Size = 11;
                ...
                Chunk c6 = new Chunk("Tekući račun: 205-0000000270172-07", _font);
                c3.Font.Color = new BaseColor(0, 0, 0);
                c3.Font.SetStyle(0);
                c3.Font.Size = 11;
                ...
                Chunk c7 = new Chunk("Adresa: Jasički put 9, 37000, Kruševac", _font);
                c3.Font.Color = new BaseColor(0, 0, 0);
                c3.Font.SetStyle(0);
                c3.Font.Size = 11;
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////////
                Chunk c8 = new Chunk(("Ime: ") + _clientFirstName, _font);
                ...
                Chunk c9 = new Chunk(("Prezime: ") + _clientLastName, _font);
                ...
                Chunk c10 = new Chunk(("Adresa: ") + _clientAddress, _font);
                ...
                Chunk c11 = new Chunk(("JMBG: ") + _clientJMBG, _font);
                ...
                Chunk c12 = new Chunk(("BPG: ") + _clientBPG, _font);
                ...
                Chunk c13 = new Chunk(("Poštanski broj: ") + _clientZipCode, _font);
                ...
                Chunk c14 = new Chunk(("Telefon: ") + _clientPhone, _font);
                ...
                p16.Add(c16);
                total.AddCell(p16);
                Chunk c17 = new Chunk("UKUPNO: ", _font);
                ...
                p17.Add(c17);
                total.AddCell(p17);
                Chunk c18 = new Chunk(finalPrice.ToString() + " RSD", _font);
